...
<body class="bg-light overflow-y-hidden">
    ...
    <div class="d-flex justify-content-between" style="height: calc(100vh - 93px);">
        ...
        <div class="d-flex align-items-center col col-11 mt-4" style="height: 100%;">
            <div class="container col-2"></div> <!--Coluna que empurra o retângulo principal lateralmente pro centro-->
            <div class="container d-flex align-items-start bg-warning px-0" style="height: 80%;">
                <div class="container-fluid bg-dark">
                    <h1 class="text-white">ZOOBOOMAFOO</h1>
                </div>
            </div>
